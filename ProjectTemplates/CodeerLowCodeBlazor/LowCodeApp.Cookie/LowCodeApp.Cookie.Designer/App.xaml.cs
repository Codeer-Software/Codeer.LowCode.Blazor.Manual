...
using LowCodeApp.Cookie.Client.Shared.AITextAnalyzer;
using LowCodeApp.Cookie.Client.Shared.ScriptObjects;
using LowCodeApp.Cookie.Designer.Lib;
using LowCodeApp.Cookie.Designer.Lib.AI;
using LowCodeApp.Cookie.Designer.Lib.DbTableToModule;
using LowCodeApp.Cookie.Designer.Lib.ExcelToModule;
using LowCodeApp.Cookie.Designer.Lib.ModuleToClass;
using LowCodeApp.Cookie.Designer.Lib.SeleniumPageObject;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Win32;

namespace LowCodeApp.Cookie.Designer
{
    public partial class App : DesignerApp
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            ScriptRuntimeTypeManager.AddType(typeof(LowCodeApp.Cookie.Client.Shared.ScriptObjects.Excel));
            ...
            BlazorRuntime.InstallBundleCss("LowCodeApp.Cookie.Client.Shared");

            IconCandidate.Icons.AddRange(LowCodeApp.Cookie.Designer.Properties.Resources.bootstrap_icons
            ...
            MainWindow.Title = "LowCodeApp.Cookie";
        ...
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.EmptyTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample.db", LowCodeApp.Cookie.Designer.Properties.Resources.sqlite_sample);
        }

        static void CreateEmptyAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.EmptyAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample_auth.db", LowCodeApp.Cookie.Designer.Properties.Resources.sqlite_sample_auth);
        }

        static void CreateGettingStandard(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.GettingStartedTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample.db", LowCodeApp.Cookie.Designer.Properties.Resources.sqlite_sample);
        }
        ...
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.InventoryManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\inventory_v1.db", LowCodeApp.Cookie.Designer.Properties.Resources.inventory_v1);
        }

        static void CreateSFA(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.SFATemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sfa_v1.db", LowCodeApp.Cookie.Designer.Properties.Resources.sfa_v1);
        }

        static void CreateProjectManagement(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.ProjectManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\project_management_v1.db", LowCodeApp.Cookie.Designer.Properties.Resources.project_management_v1);
        }

        static void CreatePatternShowcase(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.PatternShowcaseTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_v2.db", LowCodeApp.Cookie.Designer.Properties.Resources.sqlite_patterns_v2);
        }

        static void CreatePatternShowcaseAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Cookie.Designer.Properties.Resources.PatternShowcaseAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_auth_v2.db", LowCodeApp.Cookie.Designer.Properties.Resources.sqlite_patterns_auth_v2);
        }
