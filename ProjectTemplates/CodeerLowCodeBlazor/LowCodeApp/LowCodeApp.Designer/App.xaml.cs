...
using LowCodeApp.Designer.Lib;
using LowCodeApp.Designer.Lib.AI;
using LowCodeApp.Designer.Lib.DbTableToModule;
using LowCodeApp.Designer.Lib.ExcelToModule;
using LowCodeApp.Designer.Lib.ModuleToClass;
...
namespace LowCodeApp.Designer
{
    public partial class App : DesignerApp
    {
        ...
        static void CreateEmpty(string path)
        {
            ...
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample.db", LowCodeApp.Designer.Properties.Resources.sqlite_sample);
        }

        static void CreateEmptyAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.EmptyAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample_auth.db", LowCodeApp.Designer.Properties.Resources.sqlite_sample_auth);
        }
        ...
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.InventoryManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\inventory_v1.db", LowCodeApp.Designer.Properties.Resources.inventory_v1);
        }

        static void CreateSFA(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.SFATemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sfa_v1.db", LowCodeApp.Designer.Properties.Resources.sfa_v1);
        }

        static void CreateProjectManagement(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.ProjectManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\project_management_v1.db", LowCodeApp.Designer.Properties.Resources.project_management_v1);
        }

        static void CreatePatternShowcase(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.PatternShowcaseTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_v2.db", LowCodeApp.Designer.Properties.Resources.sqlite_patterns_v2);
        }

        static void CreatePatternShowcaseAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.Designer.Properties.Resources.PatternShowcaseAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_auth_v2.db", LowCodeApp.Designer.Properties.Resources.sqlite_patterns_auth_v2);
        }
