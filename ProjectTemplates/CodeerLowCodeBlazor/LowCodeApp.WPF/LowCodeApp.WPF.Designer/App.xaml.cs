...
using LowCodeApp.WPF.Designer.Lib;
using LowCodeApp.WPF.Designer.Lib.AI;
using LowCodeApp.WPF.Designer.Lib.DbTableToModule;
using LowCodeApp.WPF.Designer.Lib.ExcelToModule;
using LowCodeApp.WPF.Designer.Lib.ModuleToClass;
using LowCodeApp.WPF.Designer.Lib.SeleniumPageObject;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Win32;

namespace LowCodeApp.WPF.Designer
{
    public partial class App : DesignerApp
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            ScriptRuntimeTypeManager.AddType(typeof(LowCodeApp.WPF.Client.Shared.ScriptObjects.Excel));
            ...
            BlazorRuntime.InstallBundleCss("LowCodeApp.WPF.Client.Shared");

            IconCandidate.Icons.AddRange(LowCodeApp.WPF.Designer.Properties.Resources.bootstrap_icons
            ...
            MainWindow.Title = "LowCodeApp.WPF";
        ...
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.EmptyTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample.db", LowCodeApp.WPF.Designer.Properties.Resources.sqlite_sample);
        }

        static void CreateEmptyAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.EmptyAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample_auth.db", LowCodeApp.WPF.Designer.Properties.Resources.sqlite_sample_auth);
        }

        static void CreateGettingStandard(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.GettingStartedTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_sample.db", LowCodeApp.WPF.Designer.Properties.Resources.sqlite_sample);
        }
        ...
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.InventoryManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\inventory_v1.db", LowCodeApp.WPF.Designer.Properties.Resources.inventory_v1);
        }

        static void CreateSFA(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.SFATemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sfa_v1.db", LowCodeApp.WPF.Designer.Properties.Resources.sfa_v1);
        }

        static void CreateProjectManagement(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.ProjectManagementTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\project_management_v1.db", LowCodeApp.WPF.Designer.Properties.Resources.project_management_v1);
        }

        static void CreatePatternShowcase(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.PatternShowcaseTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_v2.db", LowCodeApp.WPF.Designer.Properties.Resources.sqlite_patterns_v2);
        }

        static void CreatePatternShowcaseAuth(string path)
        {
            using Stream stream = new MemoryStream(LowCodeApp.WPF.Designer.Properties.Resources.PatternShowcaseAuthTemplate);
            ZipFile.ExtractToDirectory(stream, path);
            EnsureSampleDbExtracted("C:\\Codeer.LowCode.Blazor.Local\\Data\\sqlite_patterns_auth_v2.db", LowCodeApp.WPF.Designer.Properties.Resources.sqlite_patterns_auth_v2);
        }
