...
<!-- 画像参照: Manual の Image/web/patterns/listpage_basic.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_bulk.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_detail.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_filtersort.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_custom.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_dialog.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/listpage_split.png (ここではコメントアウト) -->
