...
<!-- 画像参照: Manual の Image/web/patterns/layout_form.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_tab.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_fill.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_responsive.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_border.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_resize.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_proportional.png (ここではコメントアウト) -->
...
行内の全列に `Width` 必須、`MinWidth`/`MaxWidth`・リサイズ・折り返しとは併用不可 ([詳細](../Layouts.md))。
...
<!-- 画像参照: Manual の Image/web/patterns/layout_nested.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_canvas.png (ここではコメントアウト) -->
...
<!-- 画像参照: Manual の Image/web/patterns/layout_wizard.png (ここではコメントアウト) -->
