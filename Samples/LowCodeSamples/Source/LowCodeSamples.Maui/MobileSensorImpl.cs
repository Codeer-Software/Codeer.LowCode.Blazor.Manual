...
{
    //MobileSensorField (Client.Shared/Samples/MobileSensor) が使う端末センサーの MAUI 実装。
    //位置情報は AndroidManifest.xml (ACCESS_FINE_LOCATION / ACCESS_COARSE_LOCATION) と Info.plist (NSLocationWhenInUseUsageDescription) の許可が要る
