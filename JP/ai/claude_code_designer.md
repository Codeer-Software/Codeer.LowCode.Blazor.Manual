...
- 編集の詳細指示: https://raw.githubusercontent.com/Codeer-Software/Codeer.LowCode.Blazor.Manual/main/Claude/Designer/CLAUDE.md

詳細リファレンス（Docs/ 以下: ModuleDesign / Layouts / Fields / PageFrame / Scripts / Enums / AppCss 等）は必要に応じて以下から取得してください:

ベース URL: https://raw.githubusercontent.com/Codeer-Software/Codeer.LowCode.Blazor.Manual/main/Claude/Designer/Docs/
ファイル一覧: https://github.com/Codeer-Software/Codeer.LowCode.Blazor.Manual/tree/main/Claude/Designer/Docs
```
...
> 設定ファイルの仕様詳細は [designer.settings](../designer/designer_settings.md) を参照（Claude Code は同等の仕様を `Claude/Designer/Docs/ProjectSettings.md` から自動取得）。
...
- **オンライン参照のメリット**: リファレンスが更新されると自動で最新を参照できます。逆にオフライン環境では使えないので、必要なら `Docs/` を手動でダウンロードしておいてください（[GitHub のフォルダから zip ダウンロード](https://github.com/Codeer-Software/Codeer.LowCode.Blazor.Manual/tree/main/Claude/Designer)）。
...
- [GitHub: Designer](https://github.com/Codeer-Software/Codeer.LowCode.Blazor.Manual/tree/main/Claude/Designer)
